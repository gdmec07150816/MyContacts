package cn.edu.gdmec.s07150816.work7;
...
public class UpdateContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moblieEditText.setText(user.getMobile());
        ...
        switch (item.getItemId()){
            case 1:
                if (!nameEditText.getText().toString().trim().equals("")){
                    ...
                    user.setMobile(moblieEditText.getText().toString());
                    ...
                    if (ct.updateUser(user)){
                        ...
                        Toast.makeText(this,"修改失败！",Toast.LENGTH_LONG);
                    }
                }else{
                    Toast.makeText(this,"数据不能为空！",Toast.LENGTH_LONG);
                }
                break;
            case 2:
                finish();
